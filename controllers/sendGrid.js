const sendGridHtmlTemplate = (name, code) => {
  return `
...
body {font-family: 'Muli', sans-serif;}
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="200" height="64" alt="" data-proportionally-constrained="true" data-responsive="false" src=https://i.ibb.co/bWzGWvF/logo.png" height="33">
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px">Please use your verification code below to verify your email</span><span style="color: #000000; font-size: 18px; font-family: arial, helvetica, sans-serif"> and get access to thousands of exclusive Black Jack features</span><span style="font-size: 18px">.</span></div>
...
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">1. Login to the blackjack website and have fun.</span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">2. Read the instruction before starting the game.</span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">3. Play games to get the achievement badges.</div>
<div style="font-family: inherit; text-align: center"><br></div>
